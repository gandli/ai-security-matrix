...
- [智能体工具](tools/agents/) — 22（自主运行或多步骤编排的 AI 工具）
- [扫描器](tools/scanners/) — 20（基于规则或 LLM 的检测与评估工具）
- [MCP 服务器](tools/mcp-servers/) — 14（模型上下文协议（MCP）工具服务器）
- [技能集](tools/skills/) — 9（智能体技能包、提示词与剧本）
