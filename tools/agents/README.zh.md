...
- [CyberStrikeAI](aipentest-cyberstrikeai.zh.md) — 6.8k · AI 原生网络安全的行动系统——让意图变为受控执行、证据变为运行记忆，并使每次操作都优化下一次。
...
- [ares](dreadnode-ares.zh.md) — 76 · Ares 是自主安全运营平台，让 LLM 驱动的红队与蓝队智能体在真实基础设施上互相对抗，实现攻防的现实评估。
- [LLMtary](chetstriker-llmtary.zh.md) — 35 · 自主 AI 驱动的渗透测试平台。面向内外部目标的 LLM 驱动侦察、漏洞分析与利用验证。支持本地 AI（Ollama、LM Studio）与云端模型（Claude、GPT-4、Gemini）。Linux · macOS · Windows。
