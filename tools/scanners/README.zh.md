...
- [garak](nvidia-garak.zh.md) — 9.4k · LLM 漏洞扫描器。
...
- [deepteam](confident-ai-deepteam.zh.md) — 3.0k · DeepTeam 是一个对 LLM 与 AI 智能体进行红队的框架。
...
- [picklescan](mmaitre314-picklescan.zh.md) — 425 · 检测执行可疑行为的 Python Pickle 文件的安全扫描器。
